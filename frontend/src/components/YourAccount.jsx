...
const [menu,setMenu]=useState(false);
    const MenuSwitch=(data)=>{
      ...
      useEffect(()=>{
        ...
        userFormData.set("first_name",user.first_name)
        userFormData.set("last_name",user.last_name)
        userFormData.set("email",user.email)
        userFormData.set("phone",user.phone)
        setUser({
      ...
      const submit=()=>{
        ...
        console.log(token)
        fetch(`${BASE_URL}/user/updateMyAccount`,{
            method:'POST',
            headers:{
...
<ion-icon name="menu-outline"></ion-icon>
        ...
        <div className="container border border-white text-light pb-3 rounded-3">
            <div className="p-2">
                <h3 className='fw-bolder'>Your Account</h3>
